...
class GetThaiMonthTest extends \PHPUnit_Framework_TestCase{
    public function testMonthNameAsIndex(){
        ...
        $shortFormat = false;
        $actual = StringHelper::getThaiMonth(11, $shortFormat);
        $this->assertEquals('พฤศจิกายน', $actual);
    }
    public function testMonthNameAsString(){
        ...
        $shortFormat = false;
        $actual = StringHelper::getThaiMonth('December', $shortFormat);
        $this->assertEquals('ธันวาคม', $actual);
    }
    public function testMonthNameAsArray(){
        ...
        $actual = StringHelper::getThaiMonth(array(), true);
        $this->assertEquals('', $actual);
        
        $actual = StringHelper::getThaiMonth(array(), false);
        $this->assertEquals('', $actual);
    ...
    public function testGetShortMonth(){
        $shortFormat = true;
